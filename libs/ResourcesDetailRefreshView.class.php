...
class ResourcesDetailRefreshView extends AbstractResourceDetailView {
	...
	private function getRefreshPreviewArea() {
		$area = '<div class="refresh-control ui-helper-clearfix"><form action="[PREFIX]/resources/detail/[MDID]/refresh" method="POST"	id="refresh-resource-preview"><input type="hidden" name="refresh-resource" value="preview" /> <input type="submit" value="rafraichir" title="Régénérer la prévisualisation" />Prévisualisation</form>	<div class="display-result"></div></div>';
		return $area;
	}
	private function getRefreshArchiveArea() {
		$area = '<div class="refresh-control ui-helper-clearfix"><form action="[PREFIX]/resources/detail/[MDID]/refresh" method="POST"	id="refresh-resource-archive"><input type="hidden" name="refresh-resource" value="archive" /> <input type="submit" value="rafraichir" title="Reconstruire l\'archive téléchargeable"/>Archive</form>	<div class="display-result"></div></div>';
		return $area;
	}
	private function getRefreshResourceIndexArea() {
		$area = '<div class="refresh-control ui-helper-clearfix"><form action="[PREFIX]/resources/detail/[MDID]/refresh" method="POST"	id="refresh-resource-index"><input type="hidden" name="refresh-resource" value="content-index" /> <input type="submit" value="rafraichir" title="Réindexer dans le moteur de recherche" />Réindexation</form>	<div class="display-result"></div></div>';
		return $area;
	}
